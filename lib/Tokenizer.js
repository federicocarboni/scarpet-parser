 ...
 *
 * Based on [gnembon/fabric-carpet Tokenizer.java][1] but more powerful as it
 * allows to retain more information about the actual code.
 *
...
export class Tokenizer {
    ...
    /**
     * @returns {Token} Reads the next token, or `Token.NONE` if end of file is
     * reached.
     */
    nextToken() {
        this.skipWhitespace();
