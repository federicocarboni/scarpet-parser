...
export class Tokenizer {
     ...
     */
    getPosition() {
        return new Position(this.offset, this.line, this.character);
    }
     ...
     *
     * @private
     * @param {Diagnostics} diagnostic - Diagnostic to report.
     */
    ...
    readIdent() {
        ...
        const value = this.input.slice(pos.pos, this.offset);
        this.skipWhitespace();
        const tokenType =
            this.getChar() === 0x28 /* ( */
                ? TokenTypes.Function
    ...
    readComment() {
        ...
        if (!this.allowComments) this.error(Diagnostics.UnexpectedComment, pos, end);
    ...
    readEllipsis() {
        ...
        if (this.getChar() !== 0x2e /* . */ || this.peekChar() !== 0x2e) {
            this.error(Diagnostics.UnknownOperator, pos);
    ...
    nextToken() {
        ...
        switch (c) {
            ...
            case 0x24 /* $ */:
                if (!this.allowNewLineMarkers) this.error(Diagnostics.UnexpectedNewLineMarker);
