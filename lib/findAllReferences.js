import {findAssign, findVarDefinitionInScope} from './findDefinition.js';
...
/**
 * @param {import('./Parser').Node | null} root
 * @param {import('./Parser.js').FunctionDeclaration
 *     | import('./Parser').FunctionExpression
 *     | null} node
 * @returns {import('./diagnostic.js').Range[]}
 */
export function findAllFunctionReferences(root, node) {
    /** @type {import('./Parser').Node[]} */
    const references = [];
...
/**
 * @param {import('./Parser.js').Node} root
 * @param {import('./Parser.js').StringLiteral} str
 */
export function isFunctionReference(root, str) {}
